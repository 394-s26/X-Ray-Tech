...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-3 rounded-full border-2 border-slate-600 text-gray-600 dark:text-slate-300 hover:bg-black/10 dark:hover:bg-white/10 transition-colors overflow-hidden"
    >
