...
These are intentionally thin — accessibility primitives, X-Ray Tech styling, no design system bloat. Drop them into a Next.js / Vite project, extend as needed.
