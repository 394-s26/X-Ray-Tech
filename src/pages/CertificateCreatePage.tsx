...
import { AppLogoIcon, ArrowRightIcon } from '../services/svgIcons';
...
export const CertificateCreatePage = () => {
  ...
  return (
    <AuthBackground>
      ...
      <div className="login-card login-card--wide relative z-10 mx-4 max-h-[min(100dvh-2rem,900px)] w-full shrink-0">
        <div className="login-card-header shrink-0">
          <AppLogoIcon size={28} />
          <span className="login-logo-text">X-Ray Tech</span>
        </div>

        <div className="login-card-body login-card-body--scroll">
          ...
          <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link to="/demo" className="font-medium text-blue-600 hover:underline dark:text-blue-400">
              Open the demo page
            </Link>
            .
          </p>
